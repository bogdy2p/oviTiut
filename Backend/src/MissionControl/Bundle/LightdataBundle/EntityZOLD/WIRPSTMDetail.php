 ...
 * WIRPSTMDetail
 *
 * @ORM\Table(name= "lightdata_WIRPSTM_detail")
 * @ORM\Entity
 */
class WIRPSTMDetail {
     ...
     *
     * @ORM\ManyToOne(targetEntity="MissionControl\Bundle\LightdataBundle\Entity\WIRPSingleTouchpointMix", inversedBy="details")
