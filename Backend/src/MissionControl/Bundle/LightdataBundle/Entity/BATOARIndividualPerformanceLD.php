 ...
 *
 * @ORM\Table(name = "lightdata_BATOAR_individualperformance")
 * @ORM\Entity
 */
class BATOARIndividualPerformanceLD {
     ...
     * @var BATOAResultLD
     *
     * @ORM\ManyToOne(targetEntity="MissionControl\Bundle\LightdataBundle\Entity\BATOAResultLD", inversedBy="individualperformances")
     ...
     *
     * @param float $value
     * @return BATOARIndividualPerformanceLD
     */
