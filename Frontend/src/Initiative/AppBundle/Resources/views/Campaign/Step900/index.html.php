...
<div class="container-fluid min-height">
	<div class="row" style="display: flex;">
			...
			<div class="col-xs-offset-10 col-xs-offset-1 min-height campaign-content-container">
				...
				<div class="row get_api" data-api="<?php echo $_COOKIE['api']; ?>">
					<div class="col-xs-12">
						...
						<h1 class="evo-header-big margin-top-0 text-swap font_stack_4">Outcome</h1>
						<div class="evo-space"></div>
					</div>
					<div class="col-xs-12">
						<!-- COPY CONTENT FROM DEMO PAGE -->
					</div>

					<div class="col-xs-12">
						<div class="evo-space"></div>
						<?php echo $view->render('InitiativeAppBundle:Files:index.html.php', array('userCanEdit' => $userCanEdit, 'project_id' => $project_id, 'task_id' => "900", 'real_TaskID' => $real_TaskID)); ?>
					</div>
		...
		<div class="col-xs-4 sidebar_bg">
			<?php echo $view->render('InitiativeAppBundle:Inc:CampaignSidebar/index.html.php', array('campaignName' => $campaign['Campaign']['CampaignName'], 'userCanEdit' => $userCanEdit, 'project_id' => $project_id, 'task_id' => "900", 'real_TaskID' => $real_TaskID)); ?>
		</div>
	</div>
</div>